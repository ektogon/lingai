package com.example.lingai.presentation.screens.lesson
...
import com.example.lingai.presentation.components.LazyVerticalTopics
import com.example.lingai.presentation.screens.dialogs.TopicDetailsDialog
import com.example.lingai.presentation.viewmodels.LessonsViewModel
...
fun LessonsPage(navController: NavController, viewModel: LessonsViewModel = hiltViewModel()) {
    ...
    AnimatedVisibility(
        ...
        selectedTopic?.let { topic ->
            TopicDetailsDialog(
                topicUI = viewModel.getTopicUi(topic),
