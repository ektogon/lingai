...
val GreenGradient = Color(0xFF588B5E)
val GreenLight = Color(0xFFE5F4EA)
val Blue600 = Color(0xFF6F94E5)
val Blue700 = Color(0xFF5A7EC9)
val SoftBlue = Color(0xFFB8C4EA)

val gray_400 = Color(0xff99A1AF)
val gray_600 = Color(0xff4A5565)
val DarkCharcoal = Color(0xFF2B2B2B)
...
val Correct = Color(0xFF0ead69)
val CorrectLight = Color(0xFFE8F5E9)
val WrongLight = Color(0xFFFFEBEE)
